...
#### 3. How can you generate a random number between 1 - 7 with only a die?
  - Idea is to have equal probability of 1/7 for each output {1,2,3,4,5,6,7}. Roll dice for 7 times, sum ouputs and the following ranges will map to desired outputs {1,2,3,4,5,6,7} -> {[7,12], [13,18], [19,24], [25,30], [31,36], [37,42]} 
